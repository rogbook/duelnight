...
[
  {
    ...
    "trigger": "passive",
    "conditions": [{ "kind": "active_don_attached_min", "value": 1 }, { "kind": "own_turn" }],
    "actions": [
      {
        "kind": "power_modifier",
        "delta": 1000,
        "duration": "while_active",
        "target": "self_character_any",
        "scope": "all",
      },
    ],
  },
    ...
    "actions": [
      {
        ...
        "target": "self_leader_or_character",
        "count": 1,
      },
    ...
    "actions": [
      {
        ...
        "delta": -3000,
        "duration": "this_turn",
        "target": "opponent_leader_or_character",
        "count": 2,
      },
    ],
  },
