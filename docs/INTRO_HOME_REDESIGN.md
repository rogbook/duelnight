...
- [x] 티어 구간 임계값 → ELO 기본 1000·K=32 기준 **1000 앵커로 보정**(challenger 1450 / diamond 1300 / platinum 1180 / gold 1080 / silver 980 / bronze<980). 실데이터 누적 시 재조정(권장). _MCP/네트워크 차단으로 실분포 직접 확인은 보류._
