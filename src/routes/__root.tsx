...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "DuelNight" },
      { name: "description", content: "DuelNight — 원피스·포켓몬·디지몬 TCG 전적·승률·덱·일정·매장을 한 곳에서." },
      { name: "author", content: "DuelNight" },
      { property: "og:title", content: "DuelNight" },
      { property: "og:description", content: "DuelNight — 원피스·포켓몬·디지몬 TCG 전적·승률·덱·일정·매장을 한 곳에서." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@decklog" },
      { name: "twitter:title", content: "DuelNight" },
      { name: "twitter:description", content: "DuelNight — 원피스·포켓몬·디지몬 TCG 전적·승률·덱·일정·매장을 한 곳에서." },
